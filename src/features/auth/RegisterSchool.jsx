...
const pageStyle = { minHeight: '100vh', width: '100%', overflowY: 'auto', background: 'linear-gradient(135deg, #0f172a 0%, #1e1b4b 50%, #0f172a 100%)', display: 'flex', alignItems: 'flex-start', justifyContent: 'center', padding: '40px 16px', boxSizing: 'border-box' };
