           ...
           leaderboard.length === 0 ? <div style={{ textAlign: 'center', padding: '32px', color: 'var(--text-muted)', fontSize: '13px' }}>No badges awarded yet.</div> :
            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
              {leaderboard.map((lb, idx) => {
                ...
                if (rank === 1) { bgStyle = 'rgba(251, 191, 36, 0.15)'; borderStyle = '1px solid rgba(251, 191, 36, 0.5)'; colorStyle = '#F59E0B'; badgeNode = <Medal size={20} color="#F59E0B" />; }
                else if (rank === 2) { bgStyle = 'rgba(156, 163, 175, 0.15)'; borderStyle = '1px solid rgba(156, 163, 175, 0.5)'; colorStyle = '#9CA3AF'; badgeNode = <Medal size={20} color="#9CA3AF" />; }
                else if (rank === 3) { bgStyle = 'rgba(217, 119, 6, 0.15)'; borderStyle = '1px solid rgba(217, 119, 6, 0.5)'; colorStyle = '#D97706'; badgeNode = <Medal size={20} color="#D97706" />; }
