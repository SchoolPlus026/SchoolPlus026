...
-- Extracted remotely from Japan Project (nnaqayemfogpfehiaifw)
...
ALTER TABLE public.school_settings ADD CONSTRAINT school_settings_subscription_status_check CHECK ((subscription_status = ANY (ARRAY['Trial'::text, 'Paid'::text, 'Expired'::text, 'Pending'::text, 'Rejected'::text, 'Free'::text])));
